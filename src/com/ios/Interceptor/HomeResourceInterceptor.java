    ...
    public void preHandle(WebRequest request) throws Exception {
     ...
     //导航主要菜单显示
      ...
      //侧边栏显示
		...
		//获得随机Article
		List<ArticleCustom> randomArticleList = articleService.listRandomArticle(1,4);
		request.setAttribute("randomArticleList",randomArticleList,WebRequest.SCOPE_REQUEST);
		//获得热评Article
		List<ArticleCustom> mostCommentArticleList = articleService.listArticleByCommentCount(1,4);
